...
namespace SOFT151_Coursework
{
    public class Car
    {
        ...
        public void SetMake(string carMake) { this.make = carMake; }
        public void SetModel(string carModel) { this.model = carModel; }
        public void SetRegistration(string carReg) { this.registration = carReg; }
        public void SetFuelType(string fuel) { this.fuelType = fuel; }
        public void SetDateLastServiced(DateTime lastService) { this.lastServiced = lastService; }
        public void SetComments(string commentsMade) { this.comments = commentsMade; }
        ...
        public string GetReg() { return this.registration; }
        public string GetFuelType() { return this.fuelType; }
        public DateTime GetDateLastServiced() { return this.lastServiced; }
